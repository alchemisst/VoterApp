...
contract Create{
    ...
    string memory _image,string memory _ipfs) public {
        require(votingOrganizer == msg.sender,"Only allowed oragnizers can create the candidate ");
    ...
    public {
        ...
        require(votingOrganizer==msg.sender, "Only organizer are allowed to create");
    ...
    function vote(address _candidateAddress,uint256 _candiddateVoterId) 
    external {
        ...
        voter.voter_vote = _candiddateVoterId;
